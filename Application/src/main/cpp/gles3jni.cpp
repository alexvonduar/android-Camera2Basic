...
extern "C" {
    JNIEXPORT void JNICALL Java_com_example_android_camera2basic_GLES3JNILib_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_example_android_camera2basic_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_example_android_camera2basic_GLES3JNILib_step(JNIEnv* env, jobject obj);
};
...
Java_com_example_android_camera2basic_GLES3JNILib_init(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
JNIEXPORT void JNICALL
Java_com_example_android_camera2basic_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height) {
    if (g_renderer) {
...
JNIEXPORT void JNICALL
Java_com_example_android_camera2basic_GLES3JNILib_step(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        g_renderer->render();
    }
}
